          ...
          <div class="header-body mt-n5 mt-md-n6">
            <div class="row align-items-end">
              ...
              <div class="col-12 col-md-auto mt-2 mt-md-0 mb-md-3">
                ...
                <!-- Button -->
                <a href="adProject.php" class="btn btn-dark d-block d-md-inline-block">
                  Create More Project Groups
                </a>
                    ...
                    <div class='card-body'>
                      <div class='row align-items-center'>
                        ...
                        <div class='col ml-n2'>
                          ...
                          Project Duration:".$row['project_start']." To ".$row['project_stop']."
                          </h4>
                          ...
                          <p class='card-text small'>
                            <span class='text-success'>●</span> Project Type: ".$row['project_type']."
                          </p>
                        ...
                        <div class='col-auto'>
                          ...
                          <!-- Button -->
                          <a href='adProjectDetails.php?id=".$row['project_id']."' class='btn btn-sm btn-success d-none d-md-inline-block'>
                            View Project
                          </a>
                          <a href='adProjectMember.php?id=".$row['project_id']."' class='btn btn-sm btn-danger d-none d-md-inline-block'>
                            Add Members
                          </a>
                        ...
                        <div class='col-auto'>
                          ...
                          <div class='dropdown'>
                            ...
                            <div class='dropdown-menu dropdown-menu-right'>
                              ...
                              <a href='adMembersProject.php?id=".$row['project_id']."' class='dropdown-item'>
                                View Members
                              </a>
                              <hr>
                              <a href='delete/project-delete.php?id=".$row['project_id']."' class='dropdown-item'>
                                Delete Project
                              </a>
                            </div>
                          </div>
