...
if(isset($_REQUEST["addBtn"])){
    ...
    $q=mysqli_query($conn,"insert into project_members(project_id,project_name,name,userID,member_role)
    values('$project_id','$project_name','$name','$userID','$member_role')");
                  ...
                  <div class='row align-items-center'>
                    <div class='col'>
                      ...
                      <h1 class='header-title'>
                        Add Members to ".$row['project_name']."
                      </h1>
                      ...
                      <ul class='nav nav-tabs nav-overflow header-tabs'>
                        <li class='nav-item'>
                          <a href='#!' class='nav-link active'>
                            Add members who this project will be committed to 
                          </a>
                        </li>
                      </ul>
                ...
                <div class='row'>
                  <div class='col-12'>
                    ...
                    <div class='form-group'>
                      ...
                      <!-- Input -->
                      <input type='hidden' name='project_id' value='".$row['project_id']."' class='form-control'>
                      <input type='hidden' name='project_name' value='".$row['project_name']."' class='form-control'>
                ...
                <div class='row'>
                  <div class='col-12'>
                    ...
                    <div class='form-group'>
                      ...
                      <!-- Form text -->
                      <small class='form-text text-muted'>
                        Ensure the details above and roles are verified before adding member to project Group
                      </small>
