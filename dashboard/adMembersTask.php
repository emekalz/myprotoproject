  ...
  <body>
      ...
      <div class='main-content'>
                  ...
                  if ($result->num_rows>0){
                    while($row = $result->fetch_assoc()){
                      ...
                      <ul class='nav nav-tabs nav-overflow header-tabs'>
                        <li class='nav-item'>
                          <a href='adTaskDetails.php?id=".$row['task_id']."' class='nav-link'>
                            Group Discussion
                          </a>
                        </li>
                        <li class='nav-item'>
        ...
        <div class='container-fluid'>
          ...
          <?php
          include "dbconnect.php";
          $sql = "SELECT * FROM task_members  WHERE task_id='$_GET[id]'";
          $result = $conn->query($sql);
          if ($result->num_rows>0){
            while($row = $result->fetch_assoc()){
              echo " 
              ...
              <div class='card'>
                ...
                <div class='dropdown card-dropdown'>
                  ...
                  <div class='dropdown-menu dropdown-menu-right'>
                    <a href='delete/task-member.php?id=".$row['id']."' class='dropdown-item'>
                      Remove from group
                    </a>
                  </div>
                </div>
