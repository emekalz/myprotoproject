        ...
        <div class="row">
          <div class="col-12 col-xl-12">
            ...
            <?php
              ...
              $sql = "SELECT * FROM tasks ORDER BY task_name DESC";
                    ...
                    <div class='card-body'>
                      <div class='row align-items-center'>
                        ...
                        <div class='col-auto'>
                          ...
                          <!-- Button -->
                          <a href='adTaskDetails.php?id=".$row['task_id']."' class='btn btn-sm btn-success d-none d-md-inline-block'>
                            View Task
                          </a>
                          <a href='adTaskMember.php?id=".$row['task_id']."' class='btn btn-sm btn-danger d-none d-md-inline-block'>
                            Add Members
                          </a>
                        ...
                        <div class='col-auto'>
                          ...
                          <div class='dropdown'>
                            ...
                            <div class='dropdown-menu dropdown-menu-right'>
                              ...
                              <a href='adMembersTask.php?id=".$row['project_id']."' class='dropdown-item'>
                                View Members
                              </a>
                              <hr>
                              <a href='delete/task-delete.php?id=".$row['task_id']."' class='dropdown-item'>
                                Delete Task
                              </a>
                            </div>
                          </div>
