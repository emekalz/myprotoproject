                    ...
                    <div class='card-body'>
                      <div class='row align-items-center'>
                        ...
                        <div class='col-auto'>
                          ...
                          <!-- Button -->
                          <a href='projectDetails.php?id=".$row['project_id']."' class='btn btn-sm btn-success d-none d-md-inline-block'>
                            View project
                          </a>
                        </div>
                        <div class='col-auto'>
                          ...
                          <div class='dropdown'>
                            ...
                            <div class='dropdown-menu dropdown-menu-right'>
                              <a href='membersProject.php?id=".$row['project_id']."' class='dropdown-item'>
                                View Members
                              </a>
                              <hr>
