                    ...
                    if ($result->num_rows>0){
                      while($row = $result->fetch_assoc()){
                        echo "<tr>
                          ...
                          <td class='orders-product'>
                          <a href='adNotification.php?id=".$row['notification_id']."' class='btn btn-sm btn-success d-none d-md-inline-block'>
                            View Notification
                          </a>
                          </td>
                          <td class='orders-product'>
                          <a href='delete/notification-delete.php?id=".$row['notification_id']."' class='btn btn-sm btn-danger d-none d-md-inline-block'>
                            Delete Notification
                          </a>
                          </td>
                        </tr>";
