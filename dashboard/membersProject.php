...
<head>
  ...
  <body>
      ...
      <div class='main-content'>
                  ...
                  if ($result->num_rows>0){
                    while($row = $result->fetch_assoc()){
                      ...
                      <ul class='nav nav-tabs nav-overflow header-tabs'>
                        <li class='nav-item'>
                          <a href='projectDetails.php?id=".$row['project_id']."' class='nav-link'>
                            Group Discussion
                          </a>
                        </li>
                        <li class='nav-item'>
        ...
        <div class='container-fluid'>
          ...
          <?php
          include "dbconnect.php";
          $sql = "SELECT * FROM project_members  WHERE project_id='$_GET[id]'";
          $result = $conn->query($sql);
          if ($result->num_rows>0){
            while($row = $result->fetch_assoc()){
              echo " 
  ...
  <!-- <a href='profile-posts.html' class='avatar avatar-xl card-avatar card-avatar-top'>
                    <img  class='avatar-img rounded-circle border border-4 border-card' alt='...'>
                  </a> -->
