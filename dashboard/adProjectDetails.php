...
<?php
    ...
    if (isset($_POST['postBtn'])) {
       include "dbconnect.php";
        ...
        $conn->query("INSERT INTO project_chat (project_id,name,chatTime,userID,chat)
             VALUES ('$project_id','$name','$chatTime','$userID','$chat')");
    }
?>
<!doctype html>
<html lang="en">
        ...
        while($row = $result->fetch_assoc()){
                ...
                <div class='row align-items-center'>
                  <div class='col'>
                    ...
                    <ul class='nav nav-tabs nav-overflow header-tabs'>
                      ...
                      <li class='nav-item'>
                        <a href='adMembersProject.php?id=".$row['project_id']."' class='nav-link'>
                          Members
                        </a>
                      </li>
                    </ul>
          ...
          <div class='container-fluid'>
            <div class='row'>
              ...
              <?php
              include "dbconnect.php";
              $sql = "SELECT * FROM project_chat WHERE project_id='$_GET[id]' ORDER BY id DESC";
                ...
                <div class='card'>
                    ...
                    <form action="" method="post" autocomplete="off">
                      <div class='input-group input-group-lg input-group-flush input-group-merge'>
                        ...
                        <input type='text' name='chat' class='form-control form-control-appended' placeholder='Post Message'>
