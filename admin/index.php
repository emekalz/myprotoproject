    ...
    if($User==$username && $Pwd==$password){
      ...
      $msg = "Username or Password is wrong!";
        ...
        if (empty($username) && empty($password))
        {
           ...
           header('location:index.php?enter_your_details');
           exit();
        }      
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-lg-auto">
        ...
        <!-- Remember to add lecturer -->
        <li class="nav-item">
          <a class="nav-link" href="adduser.html" target="blank" >Create User</a>
        </li>
      </ul>
...
========================= -->
  <main class="content">
    <div class="ui-container ui-small">
      <div class="mb-50">
        <center><h3>H.O.D Login</h3>
        <p>Login with your username and password</p></center>
      </div>
      ...
      <form action="" method="post" autocomplete="off">
        <div class="form-group">
          ...
          required data-validation-message-required="Fill out this field">
        </div>
